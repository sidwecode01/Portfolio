...
const techIcons = {
  ...
  "Tailwind CSS": <SiTailwindcss className="text-teal-400 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "JavaScript": <FaJs className="text-yellow-400 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "Git": <FaGitAlt className="text-red-500 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "Vue.js": <FaVuejs className="text-green-500 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "Laravel": <SiLaravel className="text-red-600 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "HTML": <FaHtml5 className="text-orange-500 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "CSS": <FaCss3Alt className="text-blue-500 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "NestJS": <SiNestjs className="text-red-500 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "Next.js": <SiNextdotjs className="text-black w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "Postman": <SiPostman className="text-orange-500 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
  "Flask": <SiFlask className="text-gray-500 w-6 h-6 hover:scale-110 transition-transform duration-200" />,
};

const projects = [
  { title: "Portfolio", image: image1, description: "Ce projet est un site vitrine conçu pour présenter mes compétences en développement web, mes réalisations, mon parcours professionnel et mes projets personnels. L’objectif principal est de fournir une plateforme claire, moderne et responsive qui reflète mon identité professionnelle tout en offrant une navigation intuitive.Le portfolio est structuré en plusieurs sections : une page d’accueil avec une animation d’introduction, une section \" propos\" détaillant mon profil, une galerie de projets interactifs, une section \"Compétences\" illustrant mes outils et langages maîtrisés, ainsi qu’un formulaire de contact fonctionnel.", technologies: ["React",  "Tailwind CSS", "Git"] },
  { title: "DashBoard", image: image1, description: " Application permettant de s’abonner à différents services: météo, cinéma, Pokémon… avec des timers. Développement de micro-services réutilisables.", technologies: ["React", "NextJS", "Flask", "Postman"] },
  ...
  { title: "Yowl – Plateforme sociale de commentaires universels", image: yowl, description: "Yowl est une application web innovante qui permet à ses utilisateurs de commenter librement n’importe quel contenu en ligne, sans restriction liée au site d’origine. L’objectif est de créer une couche sociale universelle où les membres de la communauté Yowl peuvent échanger, débattre et partager leurs opinions sur tout type de contenu : articles, vidéos, images, produits, etc.", technologies: ["Vue.js", "Laravel", "JavaScript"] },
  ...
  { title: "E-Commerce Web Site (View) – Interface utilisateur d’une boutique en ligne", image: ecommerce1, description: "Ce projet représente la partie front-end d’un site e-commerce moderne, conçu pour simuler l’expérience d’achat en ligne. L’objectif était de créer une interface fluide, responsive et visuellement attrayante, en intégrant les principales fonctionnalités attendues par les utilisateurs d’une boutique en ligne. Lien du projet: https://e-commerce-amy-sidoine.netlify.app/", technologies: ["Vue.js", "Laravel", "JavaScript"] },
  { title: "Calculatrice scientifique – Logique NPI (Python)", image: image1, description: "Ce projet est une calculatrice scientifique développée en Python, reposant sur la logique de la Notation Polonaise Inverse (NPI), également appelée postfixée. Contrairement aux calculatrices classiques, celle-ci traite les expressions mathématiques sans avoir besoin de parenthèses, en respectant l’ordre des opérations via une pile (stack). Elle permet d’effectuer des calculs complexes de manière rapide et fiable.", technologies: ["Vue.js", "Laravel", "JavaScript"] },
  ...
  { title: "Trello Clone Mobile – Application de gestion de tâches", image: trelloMobileImage, description: "Trello Clone Mobile est une application mobile inspirée de Trello, conçue pour permettre aux utilisateurs de gérer leurs projets et tâches de manière intuitive, directement depuis leur smartphone. Elle reprend les principes de l’organisation par tableaux, listes et cartes, tout en offrant une interface adaptée aux usages mobiles.", technologies: ["Vue.js", "Laravel", "JavaScript"] },
...
export default function About() {
  ...
  if (!project) {
    return <div>Pas de projet correspondant à ce titre</div>
  }
