...
import me from '../assets/meUpdate.png'
...
export default function HearderDesign() {
    return (
        <div className='relative overflow-hidden min-h-[550px] sm:min-h-[650px] flex flex-col items-center '>
            <div className="md:h-[611px] h-[990px] md:w-[1600px] w-[950px] bg-gradient-to-r  absolute bg-blue-950 rounded-full transform rotate-6 -top-40 md:-top-10 z-0">
            </div>
            <Navbar />
            <section className="flex flex-col md:flex-row items-center justify-center w-full px-4 md:px-52 pt-24 pb-4 md:pd-24 md:pt-32 md:pb-24  md:mt-0 z-10">
                <div data-aos="fade-up" className="flex-1 md:text-left mt-10 md:mt-0">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white md-4">Nango Koffi Sidoine</h1>
