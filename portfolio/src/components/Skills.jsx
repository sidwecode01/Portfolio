        ...
        <div>
            <main id="skills" className="py-6 py-4 sm:p-6 md:py-10 md:py-8">
                <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                    <div data-aos="fade-up" data-aos-delay="300" className="relation p-3 col-start-1 flex flex-cols-reverse rounded-lg bg-gradient-to-t">
                    ...
                    <p data-aos="fade-up" data-aos-delay="600" className="mt-4 text-sm leadind-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 text-blue-950 lg:col-span-1">
Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente fugit quod officiis, beatae suscipit tempora molestias natus nam earum excepturi assumenda, laboriosam obcaecati sunt repellendus doloremque, atque nostrum harum. Quod.
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum optio maiores reprehenderit amet eligendi, provident illo, ipsa, quisquam ipsum aspernatur accusantium corrupti at explicabo. Maiores ad atque odit voluptatibus nostrum.
                    </p>
