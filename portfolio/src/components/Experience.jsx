                ...
                <div data-aos="fade-up" data-aos-delay="500" className="flex flex-wrap -m-4 text-center">
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2 border-blue-200 px-4 py-6 rounded-lg">
                            <h2 className="font-medium text-3xl text-gray-900">+6 mois</h2>
                    ...
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2 border-blue-200 px-4 py-6 rounded-lg">
                            <h2 className="font-medium text-3xl text-gray-900">+15</h2>
                            <p className="leading-relaxed">Project concrets</p>
                        </div>
                    </div>

                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2 border-blue-200 px-4 py-6 rounded-lg">
                            <h2 className="font-medium text-3xl text-gray-900">+3</h2>
                    ...
                    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2 border-blue-200 px-4 py-6 rounded-lg">
                            <h2 className="font-medium text-3xl text-gray-900">+6</h2>
                            <p className="leading-relaxed">FrameWork</p>
                        </div>
                    </div>
